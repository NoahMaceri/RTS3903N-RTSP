...
int main(int argc, char *argv[]) {
    ...
    if (strcmp(argv[1], "noise_reduction") == 0)    {
        ...
        change_isp_setting(RTS_VIDEO_CTRL_ID_BLC, val, isp_adj);
